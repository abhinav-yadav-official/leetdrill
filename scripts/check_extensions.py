...
def main():
    ...
    require("abhiyadav.in/leetdrill" in description, "description must identify the LeetDrill web app")
    ...
    require("https://abhiyadav.in/*" in firefox["permissions"], "firefox permissions must include production backend")
    require("https://abhiyadav.in/*" in chrome["host_permissions"], "chrome host permissions must include production backend")
    ...
    require("https://abhiyadav.in/leetdrill/extension/connect*" in str(chrome.get("content_scripts", [])), "chrome must inject on web connect page")
    require("https://abhiyadav.in/leetdrill/extension/connect*" in str(firefox.get("content_scripts", [])), "firefox must inject on web connect page")
