...
//      surface a notice via chrome.action.setBadgeText.
...
chrome.runtime.onInstalled.addListener(async () => {
  await chrome.alarms.create(COOKIE_ALARM, { periodInMinutes: COOKIE_PERIOD_MIN });
